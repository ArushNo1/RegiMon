    ...
    <div className="bg-bg-surface border-b border-border">
      <div className="max-w-7xl mx-auto px-6 flex items-center justify-between">
        <div className="flex gap-6">
          <button
            onClick={() => onChangeScreen('monitor')}
            className={`flex items-center gap-2 px-1 py-3.5 font-medium text-sm cursor-pointer transition-colors border-b-2 ${currentScreen === 'monitor'
